...
Mvc.prototype.Context.prototype.mapCommand = function (cmd,event,tp){
	...
	try{
		...
		this[type].add(cmd, event, cmd.execute); //this one broadc
...
require.define("/node_modules/mediator/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"./index.js"}
});

require.define("/node_modules/mediator/index.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/tests/tests.js", function (require, module, exports, __dirname, __filename) {
    var assert = require('assert'),
       Mvc = require('../index'),
       mvc =  new Mvc();
